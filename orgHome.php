...
echo "<button type='button' class='btn btn-primary' id='followBtn'>Follow</button>";
echo "<div class=info>";
echo "<h2>Name</h2>";
echo "<h5>Industry</h5>";
...
echo "<ul class='list-inline nav nav-tabs'>";
echo "<li class='active'><a href='index.php?id=orgHome'>Home</a></li>";
echo "<li><a href='index.php?id=orgCareers'>Careers</a></li>";
echo "</ul>";
echo "</div>";
echo "</div>";
echo "<br>";
